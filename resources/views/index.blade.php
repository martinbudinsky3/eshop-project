...
<div class="wrapper">
    <main class="container">
        ...
        <!--New products-->
        @component('layout.partials.carousel', ['heading' => 'Novinky', 'carouselId' => 'carousel-news', 'data' => $news])
        @endcomponent

        <!--Best reviewed products-->
        @component('layout.partials.carousel', ['heading' => 'Najlepšie hodnotené', 'carouselId' => 'carousel-bests', 'data' => $bests])
        @endcomponent
