...
<div class="wrapper center-col">
    <main class="container-fluid">
        ...
        @component('layout.partials.carousel', ['heading' => $search ? 'Najpredávanejšie' : 'Najpredávanejšie v tejto kategórií', 'carouselId' => 'carousel-rec', 'data' => $recommendedProducts])
        @endcomponent
